package com.task10.service.impl;
...
public class DynamoDbServiceImpl implements DynamoDbService {
    private static final String TABLES_TABLE = "cmtr-c04fb6ad-Tables-test";
    private static final String RESERVATIONS_TABLE = "cmtr-c04fb6ad-Reservations-test";
    ...
    @Override
    public Tables getTablesById(int id) throws TableNotFoundException {
        DynamoDB dynamoDB = new DynamoDB(amazonDynamoDB);
        Table table = dynamoDB.getTable(TABLES_TABLE);
